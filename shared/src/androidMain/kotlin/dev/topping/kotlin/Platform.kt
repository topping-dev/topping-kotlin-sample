        ...
        actual fun GetBindings(): HashMap<Any, Any>? {
            if(bindingMap == null)
            {
                bindingMap = hashMapOf(
                    ...
                    android.widget.LGMapView::class to LGMapView::class,
                    ...
                    android.widget.LGTableLayout::class to LGTableLayout::class,
                    android.widget.LGTableRow::class to LGTableRow::class,
                    ...
                    dev.topping.android.LuaMapCircle::class to LuaMapCircle::class,
                    dev.topping.android.LuaMapImage::class to LuaMapImage::class,
                    dev.topping.android.LuaMapMarker::class to LuaMapMarker::class,
                    dev.topping.android.LuaMapPolygon::class to LuaMapPolygon::class,
                    dev.topping.android.LuaMapPolyline::class to LuaMapPolyline::class,
